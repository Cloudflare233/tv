  ...
  render() {
    ...
    return (
      <div>
        <ReactPlayer
          ref={this.ref}
          className="react-player h-1/2 rounded-lg"
          width="100%"
          height="100%"
          url={url}
          pip={pip}
        ...
        />
        {info === true ? (
          <div className="text-xs sm:text-sm text-zinc-800 absolute rounded-br-lg top-[4.5rem] sm:top-[6.75rem] px-12 py-10 leading-relaxed bg-white/30 dark:bg-black/30 backdrop-blur-lg w-2/3 sm:w-1/3">
        ...
        <div className="resize flex flex-col z-30 top-[17.5rem] sm:top-[31rem] w-3/4 sm:w-1/3 left-4 right-4 sm:left-36 sm:right-36 mx-auto backdrop-blur-lg absolute px-4  py-2 rounded-lg bg-white/30 dark:bg-black/30">
          <div className="z-40 mx-auto flex flex-row justify-between space-x-4 sm:space-x-12">
            <div className="flex flex-row space-x-2">
              ...
              <input
                ...
                className="hidden sm:block w-16 mt-3.5"
              />
            </div>
            ...
            <div className="flex flex-row space-x-3">
              <button onClick={this.handleClickFullscreen}>
                <Icon
                  className="w-4 h-4 sm:w-6 sm:h-6 mt-0 sm:mt-1"
